function initMap() {
    ...
    },
    {
        ...
        name: 'Trevi Fountain',
        description: 'The Trevi Fountain (Italian: Fontana di Trevi) is a fountain in the Trevi district in Rome, Italy, designed by Italian architect Nicola Salvi.',
        website: 'https://en.wikipedia.org/wiki/Trevi_Fountain',
    },
    {
        coords: {
            lat: 41.902168,
            lng: 12.453937
        }, // 41.902168, 12.453937 - St Peters Basilica
        category: 'famous-place',
        name: 'St Peters Basilica',
        description: 'The Papal Basilica of Saint Peter in the Vatican or simply Saint Peters Basilica, is a church built in the Renaissance style .',
        website: 'https://en.wikipedia.org/wiki/St._Peter%27s_Basilica',
    },
    {
        coords: {
            lat: 41.8902,
            lng: 12.4922
        }, // 41.8902, 12.4922 - St Peters Basilica
        category: 'famous-place',
        name: 'Colosseum',
        ...
        website: 'https://en.wikipedia.org/wiki/Colosseum',
    },
    ];
